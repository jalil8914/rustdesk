...
def build_flutter_dmg(version, features):
    ...
    # The bundle is named from PRODUCT_NAME in AppInfo.xcconfig, so discover it
    # instead of hardcoding - and quote it, the branded name contains a space.
    release_dir = './build/macos/Build/Products/Release'
    apps = glob.glob(f'{release_dir}/*.app')
    if not apps:
        raise Exception(f'no .app bundle found in {release_dir}')
