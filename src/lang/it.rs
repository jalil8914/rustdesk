...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Aqsacloud..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), Aqsacloud potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Aqsacloud a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a Aqsacloud il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a Aqsacloud il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a Aqsacloud di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [Aqsacloud Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep Aqsacloud background service", "Mantieni il servizio di Aqsacloud in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione Aqsacloud, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show Aqsacloud", "Visualizza Aqsacloud"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a Aqsacloud 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a Aqsacloud."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di Aqsacloud."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password Aqsacloud"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare Aqsacloud e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna Aqsacloud Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di Aqsacloud come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da Aqsacloud"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra Aqsacloud è aperta"),
        ...
        ("About Aqsacloud", "Info su Aqsacloud"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client Aqsacloud remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, Aqsacloud verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, Aqsacloud salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, Aqsacloud non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server Aqsacloud non include questa funzionalità."),
