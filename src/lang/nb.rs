...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til Aqsacloud-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan Aqsacloud ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere Aqsacloud på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi Aqsacloud \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi Aqsacloud \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi Aqsacloud mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [Aqsacloud Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for Aqsacloud-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi Aqsacloud tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi Aqsacloud tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende Aqsacloud."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser Aqsacloud-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke Aqsacloud og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader Aqsacloud Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre Aqsacloud i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av Aqsacloud"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis Aqsacloud-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde Aqsacloud-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader Aqsacloud-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer Aqsacloud serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil Aqsacloud falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil Aqsacloud ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: Aqsacloud server OSS inkluderer ikke denne funksjonen."),
