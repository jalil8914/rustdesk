...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Aqsacloud..."),
        ...
        ("install_tip", "Devido ao UAC, o Aqsacloud não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Aqsacloud no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Aqsacloud permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Aqsacloud permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Aqsacloud use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Aqsacloud Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Aqsacloud background service", "Manter o serviço Aqsacloud em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação Aqsacloud, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show Aqsacloud", "Mostrar Aqsacloud"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Aqsacloud as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Aqsacloud as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Aqsacloud em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do Aqsacloud"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Aqsacloud e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o Aqsacloud Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Aqsacloud de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo Aqsacloud"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Aqsacloud estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Aqsacloud"),
        ...
        ("About Aqsacloud", "Sobre o Aqsacloud"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Aqsacloud para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o Aqsacloud verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o Aqsacloud recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o Aqsacloud deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o Aqsacloud server OSS não inclui esta funcionalidade."),
