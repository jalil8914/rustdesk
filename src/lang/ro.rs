...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Aqsacloud..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Aqsacloud să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Aqsacloud."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Aqsacloud acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Aqsacloud acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Aqsacloud să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Aqsacloud Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep Aqsacloud background service", "Rulează serviciul Aqsacloud în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Aqsacloud, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show Aqsacloud", "Afișează Aqsacloud"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Aqsacloud permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Aqsacloud permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Aqsacloud care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola Aqsacloud"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi Aqsacloud pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului Aqsacloud Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul Aqsacloud pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu Aqsacloud"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web Aqsacloud Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări Aqsacloud. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About Aqsacloud", "Despre Aqsacloud"),
        ...
        ("web_id_input_tip", "Introdu ID-ul Aqsacloud al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului Aqsacloud de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește Aqsacloud Pro pentru funcționalitate completă."),
